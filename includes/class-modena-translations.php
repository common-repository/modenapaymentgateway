    ...
    return array(
       ...
       'modena_direct'           => array(
          'et'    => array(
             ...
             'locality_EE'             => __('Eesti', 'modena'),
             'locality_LV'             => __('Läti', 'modena'),
             'locality_LT'             => __('Leedu', 'modena'),
			 'description'             => __('Panga- ja kaardimaksed', 'modena'),
             'default_icon_title_text' => __('Panga- ja kaardimakseid pakub Modena Payments OÜ.', 'modena'),
          ),
          'ru_RU' => array(
             'default_image'           => __(
             'https://cdn.modena.ee/modena/assets/modena_woocommerce_direct_01511526fd.png', 'modena'),
             ...
             'locality_EE'                   => __('Эстония', 'modena'),
             'locality_LV'                   => __('Латвия', 'modena'),
			 'locality_LT'                   => __('Литва', 'modena'),
             'description'             => __('Интернет-банкинг или оплата картой', 'modena'),
             'default_icon_title_text' => __('Платежные услуги предоставляются Modena Payments OÜ.', 'modena'),
          ),
          'en_US' => array(
             'default_image'           => __(
             'https://cdn.modena.ee/modena/assets/modena_woocommerce_direct_01511526fd.png', 'modena'),
             ...
             'title'                   => __('Bank & Card Payments', 'modena'),
              'locality_EE'                   => __('Estonia', 'modena'),
              'locality_LV'                   => __('Latvia', 'modena'),
              'locality_LT'                   => __('Lithuania', 'modena'),
			  'description'             => __('Bank & Card Payments', 'modena'),
             'default_icon_title_text' => __('Modena Bank Payments is provided by Modena Payments OÜ.', 'modena'),
          ),
           'lv_LV' => array(
               'default_image'           => __('https://cdn.modena.ee/modena/assets/modena_woocommerce_direct_01511526fd.png', 'modena'),
               'service_info'            => __('Servisa informācija', 'modena'), // Replace with correct Latvian translation
               'default_alt'             => __(' ', 'modena'),
               'title'                   => __('Banku un kartes maksājumi', 'modena'), // Replace with correct Latvian translation
               'locality_EE'             => __('Igaunija', 'modena'), // Replace with correct Latvian translation for "Estonia"
               'locality_LV'             => __('Latvija', 'modena'), // "Latvia" in Latvian
			   'locality_LT'             => __('Lietuva', 'modena'),
               'description'             => __('Banku un kartes maksājumi', 'modena'), // Replace with correct Latvian translation
               'default_icon_title_text' => __('Modena maksājumi tiek nodrošināti ar Modena Payments OÜ.', 'modena'), // Replace with correct Latvian translation
           ),
       ),
    );
  }
