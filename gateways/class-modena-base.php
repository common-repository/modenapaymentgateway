...
abstract class Modena_Base_Payment extends WC_Payment_Gateway {
  ...
  public function process_payment($order_id) {
    ...
    $locality = isset($_POST['modena_selected_locality']) ? sanitize_text_field($_POST['modena_selected_locality']) : null;
    ...
    $request = new ModenaRequest($application,
      add_query_arg('wc-api', sprintf('modena_response_%s', $this->id), home_url('/')),
      add_query_arg('wc-api', sprintf('modena_cancel_%s', $this->id), home_url('/')),
      add_query_arg('wc-api', sprintf('modena_async_response_%s', $this->id), home_url('/'))
    );
